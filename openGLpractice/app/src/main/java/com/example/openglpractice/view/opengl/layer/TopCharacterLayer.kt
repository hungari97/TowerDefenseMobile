...
class TopCharacterLayer(override val render: Renderer) : IDrawableLayer {
    ...
    var matrix /*: Array<Array<Character<*>?>>*/ = render.presenter.logicCharacterMatrix()
    ...
    override fun updateMatrix() {
        matrix = render.presenter.logicCharacterMatrix()
        initialize()
    }
}