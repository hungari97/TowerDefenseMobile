...
import com.example.openglpractice.TileType.*
...
class LessonFourRenderer(activityContext: Context) : GLSurfaceView.Renderer {
    ...
    val layers= listOf<DrawableLayer>(
        ...
        FieldLayer(this,1.0f),
        FieldLayer(this,0.0f),
        FeatureLayer(this)
    )
    ...
    override fun onSurfaceCreated(
        ...
        // Load the texture
        mTextureDataHandle =
            TextureHelper.loadTexture(mActivityContext, R.drawable.texture_map_example)
    }
    ...
    private fun calculateTextureCoords(
        ...
        var temp: FloatArray = FLOOR.textureIndexes
